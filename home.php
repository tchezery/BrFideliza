...
<body>
    ...
    <div id="containerBase">
        <div id="categoriesEvents">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-award-fill"
                viewBox="0 0 16 16">
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-code-slash"
                viewBox="0 0 16 16">
                <path
            ...
            <div id="dbEvent" style="
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo '<div class="eventPart" style="
                                                        border: 2px solid greenyellow;
                                                        width: 35%;
                                                        height: 60%;">';
                        echo '<p>Event:' . $row['name'] . '</p>';
                        echo '<p>Categorie:' . $row['categories'] . '</p>';
                        echo '<p>Description:' . $row['description'] . '</p>';
                        echo '<p>Limit Participant:' . $row['num_participant'] . '</p>';
                        echo '</div>';
                    }
                } else {
